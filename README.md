...
2. **Passo 2 — Pegar as chaves de API**: No menu lateral esquerdo, vá em **Project Overview** e copie o endereço em **Project URL** (ele será usado como `NEXT_PUBLIC_SUPABASE_URL`). Depois, vá em **Project Settings** > **API** e, na seção **API Keys**, copie a chave **Legacy anon** (ela será usada como `NEXT_PUBLIC_SUPABASE_ANON_KEY`).
...
|---|---|---|
| `NEXT_PUBLIC_SUPABASE_URL` | URL do projeto Supabase | Project Overview |
| `NEXT_PUBLIC_SUPABASE_ANON_KEY` | Chave anon do Supabase | Project Settings > API > Legacy anon |
